...
import { FileDown, ImageDown, Clock } from 'lucide-react'
    ...
    <div className="animate-fade-in">
      ...
      {stats && (
        <div className="flex items-center gap-3 mb-5 px-4 py-3 bg-blue-50 border border-blue-200 rounded-xl text-xs">
          <span className="text-blue-700 font-semibold">
            {stats.totalUnits?.toLocaleString('id')} unit tersimpan di Supabase
          </span>
          {lastUpdated && (
          ...
          <span className="ml-auto text-blue-400">Data diambil realtime saat export</span>
        </div>
      )}
      ...
      <div className="card p-5 mb-6">
        ...
        <p className="text-xs text-slate-400 mb-4">
          Export semua {Object.keys(AREA_CONFIG).length} kombinasi operator-area
        </p>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <div className="text-xs text-slate-400 mt-0.5">
                          {cfg.warehouses.length} warehouse · owner={cfg.owner}
                        </div>
                      </div>
                    </div>
